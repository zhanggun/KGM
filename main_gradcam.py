...
parser.add_argument('--model-path', type=str, default="runs_s/train/exp/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='test/4015.jpg', help='input image path')
parser.add_argument('--output-dir', type=str, default='runs_s/heatmap', help='output dir')
